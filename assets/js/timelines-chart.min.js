...
! function(t, n) {
    ...
    function g(t, n, e) {
        var r = (n - t) / Math.max(0, e),
            ...
            a = r / Math.pow(10, i);
        return i >= 0 ? (a >= c ? 10 : a >= f ? 5 : a >= h ? 2 : 1) * Math.pow(10, i) : -Math.pow(10, -i) / (a >= c ? 10 : a >= f ? 5 : a >= h ? 2 : 1)
    }
    ...
    function p(t, n, e) {
        var r = Math.abs(n - t) / Math.max(0, e),
            ...
            a = r / i;
        return a >= c ? i *= 10 : a >= f ? i *= 5 : a >= h && (i *= 2), n < t ? -i : i
    }
    ...
    function k(t, n) {
        ...
        function f(f) {
            ...
            }))), C.remove(), _.attr("d", 4 === t || 2 == t ? o ? "M" + l * o + "," + m + "H0.5V" + v + "H" + l * o : "M0.5," + m + "V" + v : o ? "M" + m + "," + l * o + "V0.5H" + v + "V" + l * o : "M" + m + ",0.5H" + v), k.attr("opacity", 1).attr("transform", (function(t) {
                return c(y(t))
            })), D.attr(s + "2", l * a), z.attr(s, l * p).text(g), x.filter(S).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", 2 === t ? "start" : 4 === t ? "end" : "middle"), x.each((function() {
                this.__axis = y
            }))
        }
    ...
    function J(t) {
        var n, e;
        return t = (t + "").trim().toLowerCase(), (n = I.exec(t)) ? (e = n[1].length, n = parseInt(n[1], 16), 6 === e ? K(n) : 3 === e ? new rt(n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | 240 & n, (15 & n) << 4 | 15 & n, 1) : 8 === e ? tt(n >> 24 & 255, n >> 16 & 255, n >> 8 & 255, (255 & n) / 255) : 4 === e ? tt(n >> 12 & 15 | n >> 8 & 240, n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | 240 & n, ((15 & n) << 4 | 15 & n) / 255) : null) : (n = X.exec(t)) ? new rt(n[1], n[2], n[3], 1) : (n = q.exec(t)) ? new rt(255 * n[1] / 100, 255 * n[2] / 100, 255 * n[3] / 100, 1) : (n = B.exec(t)) ? tt(n[1], n[2], n[3], n[4]) : (n = V.exec(t)) ? tt(255 * n[1] / 100, 255 * n[2] / 100, 255 * n[3] / 100, n[4]) : (n = W.exec(t)) ? ut(n[1], n[2] / 100, n[3] / 100, 1) : (n = G.exec(t)) ? ut(n[1], n[2] / 100, n[3] / 100, n[4]) : $.hasOwnProperty(t) ? K($[t]) : "transparent" === t ? new rt(NaN, NaN, NaN, 0) : null
    }
    ...
    function nt(t) {
        return t instanceof U || (t = J(t)), t ? new rt((t = t.rgb()).r, t.g, t.b, t.opacity) : new rt
    }
    ...
    function lt(t) {
        ...
        var n = (t = t.rgb()).r / 255,
            ...
            u = a - i,
            l = (a + i) / 2;
        return u ? (o = n === a ? (e - r) / u + 6 * (e < r) : e === a ? (r - n) / u + 2 : (n - e) / u + 4, u /= l < .5 ? a + i : 2 - a - i, o *= 60) : u = l > 0 && l < 1 ? 0 : o, new st(o, u, l, t.opacity)
    }
    ...
    E(U, J, {
        ...
        brighter: function(t) {
            return t = null == t ? Y : Math.pow(Y, t), new rt(this.r * t, this.g * t, this.b * t, this.opacity)
        },
        darker: function(t) {
            return t = null == t ? R : Math.pow(R, t), new rt(this.r * t, this.g * t, this.b * t, this.opacity)
        },
        rgb: function() {
            return this
        },
        ...
        formatRgb: at,
        toString: at
    })), E(st, (function(t, n, e, r) {
        return 1 === arguments.length ? lt(t) : new st(t, n, e, null == r ? 1 : r)
    }), L(U, {
        brighter: function(t) {
            return t = null == t ? Y : Math.pow(Y, t), new st(this.h, this.s, this.l * t, this.opacity)
        },
        darker: function(t) {
        ...
        rgb: function() {
            var t = this.h % 360 + 360 * (this.h < 0),
                ...
                r = e + (e < .5 ? e : 1 - e) * n,
                i = 2 * e - r;
            return new rt(ct(t >= 240 ? t - 240 : t + 120, i, r), ct(t, i, r), ct(t < 120 ? t + 240 : t - 120, i, r), this.opacity)
        },
        displayable: function() {
    ...
    var dt, mt = (dt = function(t) {
        ...
        var n, e, r = t.length,
            ...
            a = new Array(r),
            o = new Array(r);
        for (n = 0; n < r; ++n) e = et(t[n]), i[n] = e.r || 0, a[n] = e.g || 0, o[n] = e.b || 0;
        return i = dt(i), a = dt(a), o = dt(o), e.opacity = 1,
            function(t) {
    ...
    function xt(t, n) {
        var e, r = {},
            i = {};
        for (e in null !== t && "object" == typeof t || (t = {}), null !== n && "object" == typeof n || (n = {}), n) e in t ? r[e] = St(t[e], n[e]) : i[e] = n[e];
        return function(t) {
    ...
    function At(t, n) {
        var e, r, i, a = _t.lastIndex = Mt.lastIndex = 0,
            o = -1,
            u = [],
            l = [];
        for (t += "", n += "";
            (e = _t.exec(t)) && (r = Mt.exec(n));)(i = r.index) > a && (i = n.slice(a, i), u[o] ? u[o] += i : u[++o] = i), (e = e[0]) === (r = r[0]) ? u[o] ? u[o] += r : u[++o] = r : (u[++o] = null, l.push({
            i: o,
            x: wt(e, r)
        })), a = Mt.lastIndex;
    ...
    function St(t, n) {
        var e, r, i = typeof n;
        return null == n || "boolean" === i ? ft(n) : ("number" === i ? wt : "string" === i ? (e = J(n)) ? (n = e, pt) : At : n instanceof J ? pt : n instanceof Date ? bt : (r = n, !ArrayBuffer.isView(r) || r instanceof DataView ? Array.isArray(n) ? yt : "function" != typeof n.valueOf && "function" != typeof n.toString || isNaN(n) ? xt : wt : vt))(t, n)
    }
    ...
    var Ft = Nt((function(t) {
            const n = new("function" == typeof DOMMatrix ? DOMMatrix : WebKitCSSMatrix)(t + "");
            return n.isIdentity ? Dt : zt(n.a, n.b, n.c, n.d, n.e, n.f)
        }), "px, ", "px)", "deg)"),
        Ht = Nt((function(t) {
            return null == t ? Dt : (Ct || (Ct = document.createElementNS("http://www.w3.org/2000/svg", "g")), Ct.setAttribute("transform", t), (t = Ct.transform.baseVal.consolidate()) ? zt((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f) : Dt)
        }), ", ", ")", ")");
    ...
    function Yt(t, n, e) {
        var r = t[0],
            ...
            a = n[0],
            o = n[1];
        return i < r ? (r = Rt(i, r), a = e(o, a)) : (r = Rt(r, i), a = e(a, o)),
            function(t) {
                return a(r(t))
            }
    }
    ...
    function Ot(t, n, e) {
        var r = Math.min(t.length, n.length) - 1,
            ...
            a = new Array(r),
            o = -1;
        for (t[r] < t[0] && (t = t.slice().reverse(), n = n.slice().reverse()); ++o < r;) i[o] = Rt(t[o], t[o + 1]), a[o] = e(n[o], n[o + 1]);
        return function(n) {
            var e = s(t, n, 1, r) - 1;
            return a[e](i[e](n))
        }
    ...
    function jt() {
        ...
        function c() {
            ...
            return s !== Ut && (t = o[0], n = o[l - 1], t > n && (e = t, t = n, n = e), s = function(e) {
    ...
    Wt.prototype = Gt.prototype, Gt.prototype.toString = function() {
    ...
    var Zt = {
        ...
        s: function(t, n) {
            ...
            var r = e[0],
                ...
                o = r.length;
            return a === o ? r : a > o ? r + new Array(a - o + 1).join("0") : a > 0 ? r.slice(0, a) + "." + r.slice(a) : "0." + new Array(1 - a).join("0") + Xt(t, Math.max(0, n + a - 1))[0]
        },
            ...
            function M(t) {
                ...
                if ("c" === y) M = x(t) + M, t = "";
                    ...
                    if (t = isNaN(t) ? c : x(Math.abs(t), m), v && (t = function(t) {
                        ...
                        }(t)), A && 0 == +t && "+" !== f && (A = !1), h = (A ? "(" === f ? f : s : "-" === f || "(" === f ? "" : f) + h, M = ("s" === y ? en[8 + Bt / 3] : "") + M + (A && "(" === f ? ")" : ""), _)
    ...
    function on(t) {
        ...
        return t.ticks = function(t) {
            ...
            return function(t, n, e) {
                ...
                if ((r = n < t) && (i = t, t = n, n = i), 0 === (o = g(t, n, e)) || !isFinite(o)) return [];
                if (o > 0)
                    for (t = Math.ceil(t / o), n = Math.floor(n / o), a = new Array(i = Math.ceil(n - t + 1)); ++u < i;) a[u] = (t + u) * o;
                else
                    for (o = -o, t = Math.ceil(t * o), n = Math.floor(n * o), a = new Array(i = Math.ceil(n - t + 1)); ++u < i;) a[u] = (t + u) / o;
    ...
    var hn = 1e3,
        ...
        bn = cn((function(t) {
            t.setTime(t - t.getMilliseconds() - t.getSeconds() * hn - t.getMinutes() * gn)
        }), (function(t, n) {
            t.setTime(+t + n * pn)
        }), (function(t, n) {
            return (n - t) / pn
        ...
        wn = cn((t => t.setHours(0, 0, 0, 0)), ((t, n) => t.setDate(t.getDate() + n)), ((t, n) => (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * gn) / dn), (t => t.getDate() - 1));
    ...
    function xn(t) {
        return cn((function(n) {
            ...
            return (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * gn) / mn
        }))
    }
    var _n = xn(0),
        Mn = xn(1),
        An = (xn(2), xn(3), xn(4)),
        Sn = (xn(5), xn(6), cn((function(t) {
    ...
    function Ee(t, n) {
        var e = t.getDay();
        return Vn((t = e >= 4 || 0 === e ? An(t) : An.ceil(t)).getFullYear() % 1e4, n, 4)
    }

    function Le(t) {
        var n = t.getTimezoneOffset();
        return (n > 0 ? "-" : (n *= -1, "+")) + Vn(n / 60 | 0, "0", 2) + Vn(n % 60, "0", 2)
    }
    ...
    function Ge(t, n) {
        return t = We(t), Vn(Hn.count(Ln(t), t) + (4 === Ln(t).getUTCDay()), n, 2)
    }
    ...
    function tr(t, n) {
        var e = t.getUTCDay();
        return Vn((t = e >= 4 || 0 === e ? Hn(t) : Hn.ceil(t)).getUTCFullYear() % 1e4, n, 4)
    }
    ...
    function ir(t) {
            ...
            function _(t, n) {
                return function(e) {
                    var r, i, a, o = [],
                        ...
                        l = 0,
                        s = t.length;
                    for (e instanceof Date || (e = new Date(+e)); ++u < s;) 37 === t.charCodeAt(u) && (o.push(t.slice(l, u)), null != (i = In[r = t.charAt(++u)]) ? r = t.charAt(++u) : i = "e" === r ? " " : "0", (a = n[r]) && (r = a(e, i)), o.push(r), l = u + 1);
            ...
            function M(t, n) {
                return function(e) {
                    ...
                    if (n && !("Z" in a) && (a.Z = 0), "p" in a && (a.H = a.H % 12 + 12 * a.p), void 0 === a.m && (a.m = "q" in a ? a.q : 0), "V" in a) {
                        ...
                        "w" in a || (a.w = 1), "Z" in a ? (i = (r = Rn(Yn(a.y, 0, 1))).getUTCDay(), r = i > 4 || 0 === i ? Fn.ceil(r) : Fn(r), r = Dn.offset(r, 7 * (a.V - 1)), a.y = r.getUTCFullYear(), a.m = r.getUTCMonth(), a.d = r.getUTCDate() + (a.w + 6) % 7) : (i = (r = Un(Yn(a.y, 0, 1))).getDay(), r = i > 4 || 0 === i ? Mn.ceil(r) : Mn(r), r = wn.offset(r, 7 * (a.V - 1)), a.y = r.getFullYear(), a.m = r.getMonth(), a.d = r.getDate() + (a.w + 6) % 7)
                    } else("W" in a || "U" in a) && ("w" in a || (a.w = "u" in a ? a.u % 7 : "W" in a ? 1 : 0), i = "Z" in a ? Rn(Yn(a.y, 0, 1)).getUTCDay() : Un(Yn(a.y, 0, 1)).getDay(), a.m = 0, a.d = "W" in a ? (a.w + 6) % 7 + 7 * a.W - (i + 5) % 7 : a.w + 7 * a.U - (i + 6) % 7);
                    return "Z" in a ? (a.H += a.Z / 100 | 0, a.M += a.Z % 100, Rn(a)) : Un(a)
                }
            }
            ...
            function A(t, n, e, r) {
                for (var i, a, o = 0, u = n.length, l = e.length; o < u;) {
                    ...
                    if (37 === (i = n.charCodeAt(o++))) {
                        if (i = n.charAt(o++), !(a = x[i in In ? n.charAt(o++) : i]) || (r = a(t, e, r)) < 0) return -1
        ...
        }(t), Pn = On.format, On.parse, jn = On.utcFormat, On.utcParse
    }({
        dateTime: "%x, %X",
        date: "%-m/%-d/%Y",
        time: "%-I:%M:%S %p",
    ...
    function gr(t, n, e, r, i, a, o, u, s) {
        ...
        function M(u) {
            return (o(u) < u ? g : a(u) < u ? d : i(u) < u ? m : r(u) < u ? v : n(u) < u ? e(u) < u ? y : b : t(u) < u ? w : x)(u)
        }
        ...
        function A(n, e, r) {
            if (null == n && (n = 10), "number" == typeof n) {
                ...
                return o === _.length ? (i = p(e / cr, r / cr, n), n = t) : o ? (i = (o = _[a / _[o - 1][2] < _[o][2] / a ? o - 1 : o])[1], n = o[0]) : (i = Math.max(p(e, r, n), 1), n = u), n.every(i)
            }
            return n
        }
        return c.invert = function(t) {
            ...
            var n, e = h(),
                ...
                i = e[e.length - 1],
                a = i < r;
            return a && (n = r, r = i, i = n), n = (n = A(t, r, i)) ? n.range(r, i + 1) : [], a ? n.reverse() : n
        }, c.tickFormat = function(t, n) {
            return null == n ? M : s(n)
        }, c.nice = function(t) {
            var n = h();
            return (t = A(t, n[0], n[n.length - 1])) ? h(function(t, n) {
                var e, r = 0,
    ...
    function pr() {
        return T.apply(gr(kn, Sn, _n, wn, bn, yn, vn, fn, Pn).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments)
    }

    function dr() {
        return T.apply(gr(Ln, En, Nn, Dn, Tn, Cn, vn, fn, jn).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments)
    }
    ...
    function mr() {
        ...
        return s.domain = function(i) {
            ...
            }, s.range = c(St), s.rangeRound = c(kt), s.unknown = function(t) {
    ...
    function xr(t) {
        var n = t += "",
            e = n.indexOf(":");
        return e >= 0 && "xmlns" !== (n = t.slice(0, e)) && (t = t.slice(e + 1)), wr.hasOwnProperty(n) ? {
            space: wr[n],
            local: t
        } : t
    }
    ...
    function Or(t, n, e, r, i, a) {
        for (var o, u = 0, l = n.length, s = a.length; u < s; ++u)(o = n[u]) ? (o.__data__ = a[u], r[u] = o) : e[u] = new Rr(t, a[u]);
    ...
    function Pr(t, n, e, r, i, a, o) {
        ...
        for (u = 0; u < h; ++u) s = o.call(t, a[u], u, a) + "", (l = c.get(s)) ? (r[u] = l, l.__data__ = a[u], c.delete(s)) : e[u] = new Rr(t, a[u]);
    ...
    zi.prototype = Ni.prototype = {
        ...
        selectChild: function(t) {
            return this.select(null == t ? Hr : function(t) {
                return function() {
        ...
        selectChildren: function(t) {
            return this.selectAll(null == t ? Lr : function(t) {
                return function() {
        ...
        attr: function(t, n) {
            ...
            return this.each((null == n ? e.local ? qr : Xr : "function" == typeof n ? e.local ? Gr : Wr : e.local ? Vr : Br)(e, n))
        },
        style: function(t, n, e) {
            return arguments.length > 1 ? this.each((null == n ? Zr : "function" == typeof n ? Jr : Qr)(t, n, null == e ? "" : e)) : Kr(this.node(), t)
        },
        property: function(t, n) {
            return arguments.length > 1 ? this.each((null == n ? ti : "function" == typeof n ? ei : ni)(t, n)) : this.node()[t]
        },
        ...
        text: function(t) {
            return arguments.length ? this.each(null == t ? fi : ("function" == typeof t ? gi : hi)(t)) : this.node().textContent
        },
        html: function(t) {
            return arguments.length ? this.each(null == t ? pi : ("function" == typeof t ? mi : di)(t)) : this.node().innerHTML
        },
        raise: function() {
            return this.each(vi)
        },
    ...
    function Ui(t, n) {
        var e = new Li;
        if (t instanceof Li) t.each((function(t, n) {
            e.set(n, t)
        }));
    ...
    Li.prototype = Ui.prototype = {
        ...
        entries: function() {
            var t = [];
            for (var n in this) n[0] === Ei && t.push({
                key: n.slice(1),
                value: this[n]
            });
            return t
    ...
    Ri.prototype = function(t, n) {
        var e = new Ri;
        if (t instanceof Ri) t.each((function(t) {
            e.add(t)
        }));
        else if (t) {
            var r = -1,
    ...
    function ji(t) {
        var n = t += "",
            e = n.indexOf(":");
        return e >= 0 && "xmlns" !== (n = t.slice(0, e)) && (t = t.slice(e + 1)), Pi.hasOwnProperty(n) ? {
            space: Pi[n],
            local: t
        } : t
    }
    ...
    function Ii(t) {
        return function() {
            var n = this.ownerDocument,
                e = this.namespaceURI;
            return e === Oi && n.documentElement.namespaceURI === Oi ? n.createElement(t) : n.createElementNS(e, t)
        }
    }
    ...
    function Zi(t, n, e, r, i, a) {
        for (var o, u = 0, l = n.length, s = a.length; u < s; ++u)(o = n[u]) ? (o.__data__ = a[u], r[u] = o) : e[u] = new $i(t, a[u]);
        for (; u < l; ++u)(o = n[u]) && (i[u] = o)
    }
    ...
    function Qi(t, n, e, r, i, a, o) {
        ...
        for (u = 0; u < h; ++u)(l = c[s = "$" + o.call(t, a[u], u, a)]) ? (r[u] = l, l.__data__ = a[u], c[s] = null) : e[u] = new $i(t, a[u]);
    ...
    var Ha = {};
    "undefined" != typeof document && ("onmouseenter" in document.documentElement || (Ha = {
    ...
    function Ba(t) {
        return "string" == typeof t ? new Xa([
            [document.querySelector(t)]
        ], [document.documentElement]) : new Xa([
            [t]
        ], Ia)
    }
    ...
    Xa.prototype = qa.prototype = {
        ...
        attr: function(t, n) {
            ...
            return this.each((null == n ? e.local ? ta : Ki : "function" == typeof n ? e.local ? ia : ra : e.local ? ea : na)(e, n))
        },
        style: function(t, n, e) {
            return arguments.length > 1 ? this.each((null == n ? oa : "function" == typeof n ? la : ua)(t, n, null == e ? "" : e)) : sa(this.node(), t)
        },
        property: function(t, n) {
            return arguments.length > 1 ? this.each((null == n ? ca : "function" == typeof n ? ha : fa)(t, n)) : this.node()[t]
        },
        classed: function(t, n) {
            var e = ga(t + "");
            if (arguments.length < 2) {
        ...
        text: function(t) {
            return arguments.length ? this.each(null == t ? xa : ("function" == typeof t ? Ma : _a)(t)) : this.node().textContent
        },
        html: function(t) {
            return arguments.length ? this.each(null == t ? Aa : ("function" == typeof t ? ka : Sa)(t)) : this.node().innerHTML
        },
        raise: function() {
            return this.each(Ca)
        },
        ...
        on: function(t, n, e) {
            var r, i, a = Ua(t + ""),
                o = a.length;
            if (!(arguments.length < 2)) {
                for (u = n ? Ya : Ra, null == e && (e = !1), r = 0; r < o; ++r) this.each(u(a[r], n, e));
                return this
            }
            var u = this.node().__on;
            if (u)
    ...
    var Ga = Wa("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"),
        $a = Wa("8dd3c7ffffb3bebadafb807280b1d3fdb462b3de69fccde5d9d9d9bc80bdccebc5ffed6f"),
    ...
    function Ka(t) {
        return function(t) {
            ...
            if ("Arguments" === e || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e)) return to(t, n)
        }(t) || function() {
            throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
        }()
    }
    ...
    var eo = function(t, n, e) {
            ...
            ! function(n) {
                ...
                function s(t, l) {
                    ...
                    var c = function(t) {
                        ...
                        "object" == typeof t && (j(t.r) && j(t.g) && j(t.b) ? (g = t.r, p = t.g, d = t.b, i = {
                            r: 255 * z(g, 255),
                            g: 255 * z(p, 255),
                            b: 255 * z(d, 255)
                        }, f = !0, h = "%" === String(t.r).substr(-1) ? "prgb" : "rgb") : j(t.h) && j(t.s) && j(t.v) ? (l = E(t.s), s = E(t.v), i = function(t, e, r) {
                        ...
                        }(t.h, l, s), f = !0, h = "hsv") : j(t.h) && j(t.s) && j(t.l) && (l = E(t.s), c = E(t.l), i = function(t, n, e) {
                            var r, i, a;
                ...
                function g(t, n, e, r) {
                    return [H(L(r)), H(a(t).toString(16)), H(a(n).toString(16)), H(a(e).toString(16))].join("")
                }
                ...
                s.prototype = {
                        ...
                        toHex8: function(t) {
                            return function(t, n, e, r, i) {
                                var o = [H(a(t).toString(16)), H(a(n).toString(16)), H(a(e).toString(16)), H(L(r))];
                        ...
                        if ("object" == typeof t) {
                            var e = {};
                            for (var r in t) t.hasOwnProperty(r) && (e[r] = "a" === r ? t[r] : E(t[r]));
                            t = e
                        }
                        return s(t, n)
                ...
                var R, Y, O, P = (Y = "[\\s|\\(]+(" + (R = "(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)") + ")[,|\\s]+(" + R + ")[,|\\s]+(" + R + ")\\s*\\)?", O = "[\\s|\\(]+(" + R + ")[,|\\s]+(" + R + ")[,|\\s]+(" + R + ")[,|\\s]+(" + R + ")\\s*\\)?", {
        ...
        ro = o({
            ...
            init: function(t, n) {
                n.gradient = Ja()(t), n.el = Fi(t), n.box = n.el.append("rect").attr("x", 0).attr("y", 0).attr("rx", 3).attr("ry", 3).attr("stroke", "black").attr("stroke-width", .5), n.unitLabel = n.el.append("text").attr("class", "legendText").style("text-anchor", "middle").style("dominant-baseline", "central"), n.labelFitText = no()(n.unitLabel.node()), n.startLabel = n.el.append("text").style("text-anchor", "start").style("dominant-baseline", "central"), n.startLabelFitText = no()(n.startLabel.node()), n.endLabel = n.el.append("text").style("text-anchor", "end").style("dominant-baseline", "central"), n.endLabelFitText = no()(n.endLabel.node())
            },
            update: function(t) {
                t.gradient.colorScale(t.scale), t.box.attr("width", t.width).attr("height", t.height).style("fill", "url(#".concat(t.gradient.id(), ")")), t.unitLabel.text(t.label).attr("x", .5 * t.width).attr("y", .5 * t.height).style("text-anchor", "middle").style("dominant-baseline", "central").style("fill", eo(t.scale((t.scale.domain()[t.scale.domain().length - 1] - t.scale.domain()[0]) / 2)).isLight() ? "#444" : "#CCC"), t.labelFitText.bbox({
                    width: .8 * t.width,
                    height: .9 * t.height
                }), t.startLabel.text(t.scale.domain()[0]).attr("x", .02 * t.width).attr("y", .5 * t.height).style("fill", eo(t.scale(t.scale.domain()[0])).isLight() ? "#444" : "#CCC"), t.startLabelFitText.bbox({
                    width: .3 * t.width,
                    height: .7 * t.height
                }), t.endLabel.text(t.scale.domain()[t.scale.domain().length - 1]).attr("x", .98 * t.width).attr("y", .5 * t.height).style("fill", eo(t.scale(t.scale.domain()[t.scale.domain().length - 1])).isLight() ? "#444" : "#CCC"), t.endLabelFitText.bbox({
                    width: .3 * t.width,
                    height: .7 * t.height
                })
            }
        ...
        ao = o({
            ...
            update: function(t) {
                if (t.scale) {
                    ...
                    t.legend.html(""), (n ? io : ro)().width(t.width).height(t.height).scale(t.scale).label(t.label)(t.legend.node())
                }
            }
        }),
        oo = {
    ...
    function go(t) {
        ...
        "onselectstart" in n ? e.on("selectstart.drag", ho, !0) : (n.__noselect = n.style.MozUserSelect, n.style.MozUserSelect = "none")
    }

    function po(t, n) {
        var e = t.document.documentElement,
            r = Fi(t).on("dragstart.drag", null);
        n && (r.on("click.drag", ho, !0), setTimeout((function() {
        ...
        on: function(t, n) {
            ...
            if (!(arguments.length < 2)) {
                ...
                for (; ++a < o;)
                    ...
                    for (e in r) r[e] = fo(r[e], t.name, null);
                return this
            }
            for (; ++a < o;)
    ...
    var mo, vo, yo = 0,
        ...
        So = "object" == typeof window && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
            setTimeout(t, 17)
        };
    ...
    function zo() {
        ...
        try {
            ! function() {
                ko(), ++yo;
                for (var t, n = mo; n;)(t = _o - n._time) >= 0 && n._call.call(null, t), n = n._next;
                --yo
            }()
        } finally {
            yo = 0,
                function() {
                    var t, n, e = mo,
                        r = 1 / 0;
                    for (; e;) e._call ? (r > e._time && (r = e._time), t = e, e = e._next) : (n = e._next, e._next = null, e = t ? t._next = n : mo = n);
                    vo = t, Fo(r)
                }(), _o = 0
        }
    }
    ...
    function Fo(t) {
        yo || (bo && (bo = clearTimeout(bo)), t - _o > 24 ? (t < 1 / 0 && (bo = setTimeout(zo, t - Ao.now() - Mo)), wo && (wo = clearInterval(wo))) : (wo || (xo = Ao.now(), wo = setInterval(No, 1e3)), yo = 1, So(zo)))
    }
    ...
    To.prototype = Do.prototype = {
        ...
        restart: function(t, n, e) {
            ...
            e = (null == e ? ko() : +e) + (null == n ? 0 : +n), this._next || vo === this || (vo ? vo._next = this : mo = this, vo = this), this._call = t, this._time = e, Fo()
        },
        stop: function() {
    ...
    function qo(t, n) {
        var e;
        return ("number" == typeof n ? wt : n instanceof J ? pt : (e = J(n)) ? (n = e, pt) : At)(t, n)
    }
    ...
    pu.prototype = function(t) {
        ...
        select: function(t) {
            ...
            for (var r = this._groups, i = r.length, a = new Array(i), o = 0; o < i; ++o)
                for (var u, l, s = r[o], c = s.length, f = a[o] = new Array(c), h = 0; h < c; ++h)(u = s[h]) && (l = t.call(u, u.__data__, h, s)) && ("__data__" in u && (l.__data__ = u.__data__), f[h] = l, Uo(f[h], n, e, h, f, Oo(u, e)));
        ...
        selectAll: function(t) {
            ...
            for (var r = this._groups, i = r.length, a = [], o = [], u = 0; u < i; ++u)
                for (var l, s = r[u], c = s.length, f = 0; f < c; ++f)
                    if (l = s[f]) {
                        for (var h, g = t.call(l, l.__data__, f, s), p = Oo(l, e), d = 0, m = g.length; d < m; ++d)(h = g[d]) && Uo(h, n, e, d, g, p);
                        a.push(g), o.push(l)
        ...
        transition: function() {
            for (var t = this._name, n = this._id, e = du(), r = this._groups, i = r.length, a = 0; a < i; ++a)
        ...
        on: function(t, n) {
            var e = this._id;
            return arguments.length < 2 ? Oo(this.node(), e).on.on(t) : this.each(ou(e, t, n))
        },
        attr: function(t, n) {
            var e = xr(t),
                r = "transform" === e ? Ht : qo;
            return this.attrTween(t, "function" == typeof n ? (e.local ? Zo : $o)(e, r, Xo(this, "attr." + t, n)) : null == n ? (e.local ? Vo : Bo)(e) : (e.local ? Go : Wo)(e, r, n))
        },
        ...
        style: function(t, n, e) {
            ...
            }(t, r)).on("end.style." + t, lu(t)) : "function" == typeof n ? this.styleTween(t, function(t, n, e) {
                var r, i, a;
                return function() {
                    var o = Kr(this, t),
                        u = e(this),
                        l = u + "";
                    return null == u && (this.style.removeProperty(t), l = u = Kr(this, t)), o === l ? null : o === r && l === i ? a : (i = l, a = n(r = o, u))
                }
            }(t, r, Xo(this, "style." + t, n))).each(function(t, n) {
        ...
        tween: function(t, n) {
            ...
            if (t += "", arguments.length < 2) {
                for (var r, i = Oo(this.node(), e).tween, a = 0, o = i.length; a < o; ++a)
        ...
        delay: function(t) {
            var n = this._id;
            return arguments.length ? this.each(("function" == typeof t ? nu : eu)(n, t)) : Oo(this.node(), n).delay
        },
        duration: function(t) {
            var n = this._id;
            return arguments.length ? this.each(("function" == typeof t ? ru : iu)(n, t)) : Oo(this.node(), n).duration
        },
        ease: function(t) {
            var n = this._id;
    ...
    Ni.prototype.interrupt = function(t) {
        ...
        var n, e;
        t instanceof pu ? (n = t._id, t = t._name) : (n = du(), (e = vu).time = ko(), t = null == t ? null : t + "");
        for (var r = this._groups, i = r.length, a = 0; a < i; ++a)
            for (var o, u = r[a], l = u.length, s = 0; s < l; ++s)(o = u[s]) && Uo(o, t, n, s, u, e || yu(o, n));
    ...
    function Bu() {
        return function(t) {
            ...
            function l(n) {
                var e = n.property("__brush", d).selectAll(".overlay").data([Ou("overlay")]);
                e.enter().append("rect").attr("class", "overlay").attr("pointer-events", "all").attr("cursor", Eu.overlay).merge(e).each((function() {
                    var t = Xu(this).extent;
                    Fi(this).attr("x", t[0][0]).attr("y", t[0][1]).attr("width", t[1][0] - t[0][0]).attr("height", t[1][1] - t[0][1])
                })), n.selectAll(".selection").data([Ou("selection")]).enter().append("rect").attr("class", "selection").attr("cursor", Eu.selection).attr("fill", "#777").attr("fill-opacity", .3).attr("stroke", "#fff").attr("shape-rendering", "crispEdges");
            ...
            function h(e) {
                if ((!n || e.touches) && r.apply(this, arguments)) {
                    var i, o, u, l, f, h, g, p, d, m, v, y = this,
                        b = e.target.__data__.type,
                        w = "selection" === (a && e.metaKey ? b = "overlay" : b) ? Mu : a && e.altKey ? ku : Su,
                        x = t === Hu ? null : Ru[b],
                        _ = t === Fu ? null : Yu[b],
                        M = Xu(y),
                        A = M.extent,
                    ...
                    if ("overlay" === b) {
                        ...
                        const n = [H[0], H[1] || H[0]];
                        M.selection = S = [
                            [i = t === Hu ? k : Du(n[0][0], n[1][0]), u = t === Fu ? C : Du(n[0][1], n[1][1])],
                            [f = t === Hu ? T : Tu(n[0][0], n[1][0]), g = t === Fu ? D : Tu(n[0][1], n[1][1])]
                        ], H.length > 1 && O()
                    ...
                    if (e.touches) U.moved = Y, U.ended = P;
                        ...
                        var R = Fi(e.view).on("mousemove.brush", Y, !0).on("mouseup.brush", P, !0);
                        a && R.on("keydown.brush", j, !0).on("keyup.brush", I, !0), go(e.view)
                    }
                ...
                function Y(t) {
                    for (const n of t.changedTouches || [t])
                        for (const t of H) t.identifier === n.identifier && (t.cur = Hi(n, y));
                    if (F && !m && !v && 1 === H.length) {
                        const t = H[0];
                ...
                function O(t) {
                    ...
                    switch (z = n[0] - e[0], N = n[1] - e[1], w) {
                        case Au:
                        case Mu:
                            x && (z = Tu(k - i, Du(T - f, z)), o = i + z, h = f + z), _ && (N = Tu(C - u, Du(D - g, N)), l = u + N, p = g + N);
                            break;
                        case Su:
                            H[1] ? (x && (o = Tu(k, Du(T, H[0][0])), h = Tu(k, Du(T, H[1][0])), x = 1), _ && (l = Tu(C, Du(D, H[0][1])), p = Tu(C, Du(D, H[1][1])), _ = 1)) : (x < 0 ? (z = Tu(k - i, Du(T - i, z)), o = i + z, h = f) : x > 0 && (z = Tu(k - f, Du(T - f, z)), o = i, h = f + z), _ < 0 ? (N = Tu(C - u, Du(D - u, N)), l = u + N, p = g) : _ > 0 && (N = Tu(C - g, Du(D - g, N)), l = u, p = g + N));
                            break;
                        case ku:
                            x && (o = Tu(k, Du(T, i - z * x)), h = Tu(k, Du(T, f + z * x))), _ && (l = Tu(C, Du(D, u - N * _)), p = Tu(C, Du(D, g + N * _)))
                    }
                    h < o && (x *= -1, r = i, i = f, f = r, r = o, o = h, h = r, b in Lu && L.attr("cursor", Eu[b = Lu[b]])), p < l && (_ *= -1, r = u, u = g, g = r, r = l, l = p, p = r, b in Uu && L.attr("cursor", Eu[b = Uu[b]])), M.selection && (S = M.selection), m && (o = S[0][0], h = S[1][0]), v && (l = S[0][1], p = S[1][1]), S[0][0] === o && S[0][1] === l && S[1][0] === h && S[1][1] === p || (M.selection = [
                        [o, l],
                        [h, p]
                    ], s.call(y), U.brush(t, w.name))
                }
                ...
                function P(t) {
                    ...
                    } else po(t.view, d), R.on("keydown.brush keyup.brush mousemove.brush mouseup.brush", null);
                    E.attr("pointer-events", "all"), L.attr("cursor", Eu.overlay), M.selection && (S = M.selection), qu(S) && (M.selection = null, s.call(y)), U.end(t, w.name)
                }
                ...
                function j(t) {
                    switch (t.keyCode) {
                        case 16:
                            ...
                            break;
                        case 18:
                            w === Su && (x && (f = h - z * x, i = o + z * x), _ && (g = p - N * _, u = l + N * _), w = ku, O());
                            break;
                        case 32:
                            w !== Su && w !== ku || (x < 0 ? f = h - z : x > 0 && (i = o - z), _ < 0 ? g = p - N : _ > 0 && (u = l - N), w = Au, L.attr("cursor", Eu.selection), O());
                            break;
                        default:
                            return
                    }
                ...
                function I(t) {
                    switch (t.keyCode) {
                        case 16:
                            ...
                            break;
                        case 18:
                            w === ku && (x < 0 ? f = h : x > 0 && (i = o), _ < 0 ? g = p : _ > 0 && (u = l), w = Su, O());
                            break;
                        case 32:
                            w === Au && (t.altKey ? (x && (f = h - z * x, i = o + z * x), _ && (g = p - N * _, u = l + N * _), w = ku) : (x < 0 ? f = h : x > 0 && (i = o), _ < 0 ? g = p : _ > 0 && (u = l), w = Su), L.attr("cursor", Eu[b]), O());
                            break;
                        default:
                            return
                    }
            ...
            return l.move = function(n, e) {
                n.tween ? n.on("start.brush", (function(t) {
                    ...
                    var n = this,
                        ...
                        o = c(n, r).beforestart();
                    Po(n), i.selection = null === a ? null : a, s.call(n), o.start().brush().end()
                }))
            }, l.clear = function(t) {
                l.move(t, null)
            }, f.prototype = {
                ...
                return arguments.length ? (e = "function" == typeof t ? t : bu(Nu(t)), l) : e
            }, l.filter = function(t) {
                return arguments.length ? (r = "function" == typeof t ? t : bu(!!t), l) : r
            }, l.touchable = function(t) {
                return arguments.length ? (i = "function" == typeof t ? t : bu(!!t), l) : i
    ...
    var Vu = o({
        ...
        init: function(n, e) {
            e.xGrid = C().tickFormat(""), e.xAxis = C().tickPadding(0), e.brush = Bu().handleSize(24).on("end", (function(n) {
                if (n.sourceEvent) {
        ...
        props: {
            data: {
                ...
                onChange: function(t, n) {
                    ...
                    }(t), n.zoomX = [m(n.completeFlatData, (function(t) {
                ...
                function r(t, n) {
                    return function(e, r) {
                        return function(t, n) {
                            var e = t[1],
                                r = n[1];
                            return e && r ? e[1].getTime() == r[1].getTime() ? e[0].getTime() == r[0].getTime() ? Wu(t[0], n[0]) : e[0] - r[0] : r[1] - e[1] : null
                        }(t(n ? e : r), t(n ? r : e))
                    }
                }
                var i = e((function(t) {
            ...
            n.svg = i.append("svg"), n.overviewAreaElem = i.append("div"), n.yScale = function() {
                ...
                function() {
                    ...
                    function e(t, n) {
                        ...
                        var e = this.domain(),
                            r = this.range();
                        2 === r.length && 2 !== e.length && (r = v(r[0], r[1], (r[1] - r[0]) / e.length));
                ...
                }(), n.groupTooltip = Va().attr("class", "chart-tooltip group-tooltip").direction("w").offset([0, 0]).html((function(t, e) {
                ...
                })), n.svg.call(n.groupTooltip), n.lineTooltip = Va().attr("class", "chart-tooltip line-tooltip").direction("e").offset([0, 0]).html((function(t, e) {
                    var r = e.hasOwnProperty("timeRange") ? n.xScale.range()[1] - n.xScale(e.timeRange[1]) : 0;
                    return n.lineTooltip.offset([0, r]), e.label
                })), n.svg.call(n.lineTooltip), n.segmentTooltip = Va().attr("class", "chart-tooltip segment-tooltip").direction("s").offset([5, 0]).html((function(t, e) {
                    ...
                    var r = n.zColorScale.domain()[n.zColorScale.domain().length - 1] - n.zColorScale.domain()[0],
                        i = (n.useUtc ? jn : Pn)("".concat(n.timeFormat).concat(n.useUtc ? " (UTC)" : ""));
                    ...
                    if (null == Fi(window).on("mousemove.zoomRect")) {
                        ...
                        if (!(e[0] < 0 || e[0] > n.graphW || e[1] < 0 || e[1] > n.graphH)) {
                            ...
                            Fi(window).on("mousemove.zoomRect", (function(t) {
                                t.stopPropagation();
                                var a = r(t),
                                ...
                                Fi(window).on("mousemove.zoomRect", null).on("mouseup.zoomRect", null), Fi("body").classed("stat-noselect", !1), i.remove(), n.disableHover = !1;
                                var a = r(t),
                                    o = [Math.max(0, Math.min(n.graphW, a[0])), Math.max(0, Math.min(n.graphH, a[1]))];
                                if (e[0] != o[0] || e[1] != o[1]) {
                    ...
                    var t = n.zoomX,
                        e = n.zoomY || [null, null],
                        r = n.enableOverview ? n.overviewArea.domainRange() : [m(n.flatData, (function(t) {
                            return t.timeRange[0]
                ...
                function(t) {
                    ...
                    // r.on("click", (function() {                           
                        if (!("disableHover" in n) || !n.disableHover) {
                            ...
                            Fi(this).transition().duration(70).attr("x", (function(e) {
                                ...
                                return d([1, n.xScale(e.timeRange[1]) - n.xScale(e.timeRange[0])]) + t
                            })).attr("y", (function(e) {
                    ...
                    // })).on("click", (function() {    
                        Fi(this).transition().duration(250).attr("x", (function(t) {
                            ...
                            return d([1, n.xScale(t.timeRange[1]) - n.xScale(t.timeRange[0])])
                        })).attr("y", (function(t) {
